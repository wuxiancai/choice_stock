...
- 当日推荐采用“上行九转 3–5 的趋势启动确认”产品策略：1–2 不进入推荐池，3 分最高，4、5 分递减；8、9 分为高位风险。综合推荐评分为 100 分：九转 25、主力资金强度 20、量能 12、MACD 10、RSI 9、布林 8、KDJ 6、涨幅 5、历史胜率/收益/样本 5。资金强度按 `(大单+特大单净流入) / 当日成交额` 评分，不以绝对金额偏向大市值股票。
